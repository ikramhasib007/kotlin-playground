...
class GlobalErrorHandler : ResponseEntityExceptionHandler() {
    ...
    fun handleInstructorNotValidExceptions(ex: InstructorNotValidException, request: WebRequest) : ResponseEntity<Any> { // To handle all types of runtime exceptions
    ...
    fun handleAllExceptions(ex: Exception, request: WebRequest) : ResponseEntity<Any> { // To handle all types of runtime exceptions
        logger.error("Exception observed: ${ex.message}", ex)
